 ...
 */
namespace BIT\TwitterBundle\Services;
...
class Twitter
{
  ...
  public function getLoginUrl( )
  {
    ...
    $requestToken = ( $callbackUrl = $this->getCallbackUrl( ) ) ? $this->twitter->getRequestToken( $callbackUrl )
    ...
    switch ( $this->twitter->http_code )
    {
      case 200: /* Build authorize URL and redirect user to Twitter. */
        ...
        return $redirectURL;
        break;
      default: /* return null if something went wrong. */
        return null;
    }
  }
