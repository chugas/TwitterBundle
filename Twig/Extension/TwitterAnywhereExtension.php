...
class TwitterAnywhereExtension extends \Twig_Extension
{
  ...
  public function getFunctions( )
  {
    return array( 
        ...
        'twitter_anywhere_initialize' => new \Twig_Function_Method( $this, 'renderInitialize',
            array( 'is_safe' => array( 'html' ) )),
        'twitter_anywhere_queue' => new \Twig_Function_Method( $this, 'queue', array( 'is_safe' => array( 'html' ) )),
        'twitter_anywhere_setConfig' => new \Twig_Function_Method( $this, 'setConfig',
            array( 'is_safe' => array( 'html' ) )), );
  }
  
  public function renderSetup( $parameters = array( ), $name = null )
  {
    return $this->container->get( 'fos_twitter.anywhere.helper' )
        ->setup( $parameters, $name ? : 'FOSTwitterBundle::setup.html.twig' );
  }
  
  public function renderInitialize( $parameters = array( ), $name = null )
  {
    return $this->container->get( 'fos_twitter.anywhere.helper' )
        ->initialize( $parameters, $name ? : 'FOSTwitterBundle::initialize.html.twig' );
  }
